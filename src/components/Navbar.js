    ...
    return (
        <>
            ...
            <div className="container-fluid">
                <Link className="navbar-brand" onClick={setTitleHome} to="/">{props.title}</Link>
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                        <Link className="nav-link active" onClick={setTitleHome} aria-current="page" to="/">Home</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" onClick={setTitleAbout} to="/about">{props.aboutText}</Link>
                    </li>
                </ul>
